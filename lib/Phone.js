...
The class should define a callPhone method that accepts a single argument phoneNumber
and return a status message. status message should be in the format: 'this phone number
calls other phone number'
